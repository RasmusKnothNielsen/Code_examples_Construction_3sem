...
public class UDPServer
{
    ...
    public static void main(String args[]) throws Exception
    {
        ...
        while (true)
        {
            ...
            // Create byte buffers to hold the messages that we receive
            byte[] receiveData = new byte[209];
            ...
            else if (clientMessage.startsWith("MESSAGE: QUIT"))
            {
                ...
                if (indexOfClient > -1)
                {
                    ...
                    sendToAllUsers(newClient, newClient.getUsername() + " quit the chat!",
                            udpServerSocket);
            ...
            else if (clientMessage.equals("MESSAGE: WHOISONLINE"))
            {
            ...
            else if (clientMessage.equals("MESSAGE: COMMANDS"))
            {
                Client client = createClientObjectFromPacket(receivePacket);
            ...
            else if (clientMessage.startsWith("MESSAGE: "))
            {
                ...
                // Create a client object with the information from the message sender
    ...
    public static void properStartUp()
    {
        try
        {
            ...
            System.out.println("X               K.I.S.S.                  X");
            System.out.println("X   WELCOME TO KNOTH INC SERVER SYSTEMS   X");
            System.out.println("X                V.0.2.                   X");
